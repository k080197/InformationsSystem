...
namespace Поликлиника
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO Специальность (КлассДолжности, Должность) VALUES ('" + textBox2.Text + "','" + textBox3.Text + "')";
                cmd.ExecuteNonQuery();
                ...
                OleDbDataAdapter ad = new OleDbDataAdapter("SELECT КодДолжности, КлассДолжности as Классификатор, Должность as Название FROM Специальность", conn);
                ad.Fill(ds);
                System.Data.DataTable dt = new System.Data.DataTable("Специальность");
                ad.Fill(dt);
                bs.DataSource = dt;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = @"DELETE * FROM Специальность WHERE КодДолжности = " + str;
            cmd.ExecuteNonQuery();
        }
        ...
        {
            cmd.Connection = conn;
            cmd.CommandText = @"UPDATE Специальность SET КлассДолжности = '" + textBox1.Text + "', Должность = '" + textBox2.Text + "' WHERE КодДолжности = " + str;
            cmd.ExecuteNonQuery();
