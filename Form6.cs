...
namespace Поликлиника
{
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO Диагноз (КлассДиагноза, Диагноз, СтоимостьЛечения) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "')";
                cmd.ExecuteNonQuery();
                MessageBox.Show("Запись добавлена успешно.");
                textBox1.Clear();
                dataGridView1.CurrentCell = dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[1];

                OleDbDataAdapter ad = new OleDbDataAdapter("SELECT КодДиагноза, КлассДиагноза as Классификатор, Диагноз as Название, СтоимостьЛечения as Стоимость лечения FROM Диагноз", conn);
                ad.Fill(ds);
                System.Data.DataTable dt = new System.Data.DataTable("Диагноз");
                ad.Fill(dt);
                bs.DataSource = dt;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = @"DELETE * FROM Диагноз WHERE КодДиагноза = " + str;
            cmd.ExecuteNonQuery();
        }
        ...
        {
            cmd.Connection = conn;
            cmd.CommandText = @"UPDATE Диагноз SET КлассДиагноза = '" + textBox1.Text + "', Диагноз = '" + textBox2.Text + "', СтоимостьЛечения = '" + textBox3.Text + "' WHERE КодДиагноза = " + str;
            cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            ExcelApp.Cells[1, 3] = "Диагноз";
            ExcelApp.Cells[1, 4] = "Стоимость лечения";
